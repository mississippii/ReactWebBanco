        ...
        <Row className="justify-content-center">
          <Col lg={10}>
            <Card className="border-0 shadow-sm">
              <Card.Body>
                <Card.Title as="h2" className="text-center text-primary mb-4">Underwriting of Shares</Card.Title>
                <Card.Text className="text-muted mb-4">
                  The risks of under subscription of public offerings are mitigated through underwriting. We are a licensed underwriter approved by the Bangladesh Securities and Exchange Commission (BSEC). Underwriting services are offered to companies desiring to go public through different forms, such as IPO, RPO, and Rights Issue. Issues underwritten by Alpha Capital Management Limited include:
                </Card.Text>
